...
const translations: Record<SupportedLang, TranslationMap> = {
  fr: {
    ...
    'chat.duel_invitation': 'Invitation au duel',
    'chat.challenges_you': '{name} vous défie en duel !',
    'chat.waiting_your_response': 'En attente de votre réponse...',
    'chat.waiting_response': 'En attente de réponse...',
    'chat.accepted_starting': 'Accepté - Démarrage du jeu...',
    'chat.declined': 'Refusé',
    'chat.expired': 'Expiré',
    'chat.accept': 'Accepter',
    'chat.decline': 'Refuser',
    'chat.match_complete': 'Match terminé',
    'chat.you_defeated': 'Vous avez battu {name} !',
    'chat.defeated_you': '{name} vous a battu !',
    'chat.defeated': '{winner} a battu {loser} !',
    'chat.tournament_completed': 'Tournoi terminé',
    'chat.you_won': 'Vous avez gagné !',
    'chat.winner': 'Gagnant : {name}',
    'chat.view_results': 'Voir les résultats',
    'chat.match_ready': 'Votre match est prêt',
    'chat.vs': 'vs',
    'chat.play_match_now': 'Jouer maintenant',
    'chat.tournament_in_progress': 'Tournoi en cours',
    'chat.waiting_next_match': 'En attente de votre prochain match...',
    'chat.view_tournament': 'Voir le tournoi',
    'chat.joined_tournament': 'Tournoi rejoint',
    'chat.waiting_start': 'En attente du début du tournoi...',
    'chat.invites_tournament': '{name} vous invite à rejoindre',
    'chat.join_tournament': 'Rejoindre le tournoi',
    'chat.tournament_invitation': 'Invitation au tournoi',
  ...
  en: {
    ...
    'chat.duel_invitation': 'Duel Invitation',
    'chat.challenges_you': '{name} challenges you to a duel!',
    'chat.waiting_your_response': 'Waiting for your response...',
    'chat.waiting_response': 'Waiting for response...',
    'chat.accepted_starting': 'Accepted - Starting game...',
    'chat.declined': 'Declined',
    'chat.expired': 'Expired',
    'chat.accept': 'Accept',
    'chat.decline': 'Decline',
    'chat.match_complete': 'Match Complete',
    'chat.you_defeated': 'You defeated {name}!',
    'chat.defeated_you': '{name} defeated you!',
    'chat.defeated': '{winner} defeated {loser}!',
    'chat.tournament_completed': 'Tournament Completed',
    'chat.you_won': 'You Won!',
    'chat.winner': 'Winner: {name}',
    'chat.view_results': 'View Results',
    'chat.match_ready': 'Your Match is Ready',
    'chat.vs': 'vs',
    'chat.play_match_now': 'Play Match Now',
    'chat.tournament_in_progress': 'Tournament In Progress',
    'chat.waiting_next_match': 'Waiting for your next match...',
    'chat.view_tournament': 'View Tournament',
    'chat.joined_tournament': 'Joined Tournament',
    'chat.waiting_start': 'Waiting for tournament to start...',
    'chat.invites_tournament': '{name} invites you to join',
    'chat.join_tournament': 'Join Tournament',
    'chat.tournament_invitation': 'Tournament Invitation',
  ...
  es: {
    ...
    'chat.duel_invitation': 'Invitación a duelo',
    'chat.challenges_you': '¡{name} te desafía a un duelo!',
    'chat.waiting_your_response': 'Esperando tu respuesta...',
    'chat.waiting_response': 'Esperando respuesta...',
    'chat.accepted_starting': 'Aceptado - Iniciando juego...',
    'chat.declined': 'Rechazado',
    'chat.expired': 'Expirado',
    'chat.accept': 'Aceptar',
    'chat.decline': 'Rechazar',
    'chat.match_complete': 'Partida terminada',
    'chat.you_defeated': '¡Derrotaste a {name}!',
    'chat.defeated_you': '¡{name} te derrotó!',
    'chat.defeated': '¡{winner} derrotó a {loser}!',
    'chat.tournament_completed': 'Torneo completado',
    'chat.you_won': '¡Ganaste!',
    'chat.winner': 'Ganador: {name}',
    'chat.view_results': 'Ver resultados',
    'chat.match_ready': 'Tu partida está lista',
    'chat.vs': 'vs',
    'chat.play_match_now': 'Jugar ahora',
    'chat.tournament_in_progress': 'Torneo en curso',
    'chat.waiting_next_match': 'Esperando tu próxima partida...',
    'chat.view_tournament': 'Ver torneo',
    'chat.joined_tournament': 'Torneo unido',
    'chat.waiting_start': 'Esperando que comience el torneo...',
    'chat.invites_tournament': '{name} te invita a unirte',
    'chat.join_tournament': 'Unirse al torneo',
    'chat.tournament_invitation': 'Invitación al torneo',
