...
const translations: Record<SupportedLang, TranslationMap> = {
  fr: {
    ...
    'settings.2fa_description': 'Protégez votre compte avec une vérification supplémentaire',
    'settings.2fa_disabled': 'Désactivé',
    'settings.2fa_enabled': 'Activé',
    'settings.2fa_enable': 'Activer la 2FA',
    'settings.2fa_disable': 'Désactiver la 2FA',
    'settings.2fa_scan_qr': 'Scannez ce QR code avec votre application d\'authentification',
    'settings.2fa_manual_code': 'Ou entrez ce code manuellement :',
  ...
  en: {
    ...
    'settings.2fa_description': 'Protect your account with additional verification',
    'settings.2fa_disabled': 'Disabled',
    'settings.2fa_enabled': 'Enabled',
    'settings.2fa_enable': 'Enable 2FA',
    'settings.2fa_disable': 'Disable 2FA',
    'settings.2fa_scan_qr': 'Scan this QR code with your authenticator app',
    'settings.2fa_manual_code': 'Or enter this code manually:',
  ...
  es: {
    ...
    'settings.2fa_description': 'Protege tu cuenta con verificación adicional',
    'settings.2fa_disabled': 'Desactivado',
    'settings.2fa_enabled': 'Activado',
    'settings.2fa_enable': 'Activar 2FA',
    'settings.2fa_disable': 'Desactivar 2FA',
    'settings.2fa_scan_qr': 'Escanea este código QR con tu aplicación de autenticación',
    'settings.2fa_manual_code': 'O ingresa este código manualmente:',
